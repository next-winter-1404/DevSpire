...
const MortgageRentCard = ({ sellerId, lastUpdated, amount }: IProps) => {
  ...
  return (<div className="flex flex-col items-center gap-6 p-6 border border-[#DDDDDD] rounded-[24px] bg-white transition-colors dark:!bg-[#181818] dark:border-[#333]">
    <div className="flex flex-col items-center gap-3">
      ...
      <span className="text-[18px] font-medium text-[#1E2022] dark:text-gray-200">
    ...
    <div className="flex justify-between items-center w-full">
      ...
      <div className="flex gap-2 font-bold text-[18px] text-[#1E2022] dark:text-white">
