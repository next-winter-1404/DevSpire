      ...
      <Form className="flex flex-col gap-5">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col items-start gap-2">
            <CustomSelect
              placeholder={t("selectDestinationPlc")}
              options={[
          ...
          <div className="flex flex-col items-start gap-2">
            <label
              ...
              className="font-bold text-[16px] text-[#1E2022] dark:text-[#E4E4E4]"
            >
              {t("numOfPeople")}
            </label>
            <Field
              placeholder={t("numOfPeoplePlc")}
              type="number"
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <div className="relative">
              <Field
                placeholder={t("departureDatePlc")}
                className="w-[160px] h-[46px] font-regular text-[16px] indent-4 bg-[#F5F5F5] outline-none focus:border-1 
                            focus:border-[#0D3B66] rounded-[40px]   
                            sm:w-[360px]   md:w-[455px]            
                            dark:bg-[#404040]"
        ...
        <button className="w-full py-4 text-[#FFFFFF] bg-[#0D3B66] rounded-[40px] cursor-pointer">
          {t("searchButton")}
        </button>
      </Form>
    </Formik>
