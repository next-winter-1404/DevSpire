  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col  lg:flex-row gap-6 w-full lg:w-[1212px] top-[70px] mx-auto relative">
        <div className="order-2 lg:order-none relative bg-[#E8EEF3] dark:bg-[#27272A] rounded-xl shadow-lg border border-gray-200 dark:border-zinc-700 flex items-center justify-center w-full lg:w-[594px] h-auto lg:h-[535px]">
          <ContactForm />
        </div>
        <div className="flex flex-col gap-3 w-full lg:w-auto">
          <div className="hidden lg:flex relative bg-[#E8EEF3] dark:bg-[#434d65] rounded-xl shadow-lg border border-gray-200 dark:border-zinc-700 items-center justify-center w-[594px] h-[314px]">
            <Image
          ...
          <div
            className="order-3 lg:order-none bg-slate-50 dark:bg-[#27272A] rounded-xl
                         shadow-lg border border-gray-200 dark:border-zinc-700 px-6 lg:px-8 flex items-center
                          w-full p-4 "
          >
