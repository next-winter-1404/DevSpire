        ...
        <div className='flex justify-center mt-30 px-12'>
            <div className='flex flex-col items-start gap-8'>
                ...
                <div className='flex flex-row flex-wrap justify-center gap-10'>
                    <CategoryBigCard title={t('apartment')} imageUrl='/images/home/apartment.jpg'/>
                    <div className='flex flex-col gap-10'>
                        <CategorySmallCard title={t('villaEstate')} imageUrl='/images/home/villa-estate.png'/>
                        <CategorySmallCard title={t('withSwimmingPool')} imageUrl='/images/home/with-swimmingpool.jpg'/>
                    </div>
                    <div className='flex flex-col gap-10'>
