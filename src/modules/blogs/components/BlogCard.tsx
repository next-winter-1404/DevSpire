...
const BlogCard = ({ item }: IBlogCard) => {
  return (
    ...
    >
      <div
        className="relative w-full h-56 bg-gradient-to-br from-blue-600
      ...
      <div className="flex flex-col gap-4 p-8">
        <div className="flex flex-col gap-3">
          ...
          <p className="font-regular text-[16px] text-gray-500 dark:text-gray-300 leading-relaxed line-clamp-2">
            {item.caption}
          </p>
        </div>

        <div className="w-full h-[1px] bg-gray-100 dark:bg-[#777777]/50 my-2"></div>
