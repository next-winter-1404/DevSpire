...
const LocationsTableRow = ({ item }: IProps) => {
  ...
  return (
    <>
      <tr
        className="flex justify-between w-full py-4 border-y border-[#DDDDDD] relative   
        dark:border-[#777777]
        md:flex md:items-center"
      >
        <td className="flex flex-col gap-2 md:flex-row">
          <div className="text-[#1E2022] md:w-104 dark:text-[#E4E4E4]">
            <span>{item.areaName ? item.areaName : "فاقد نام"}</span>
          </div>
          <div className="text-[#1E2022] md:w-64 dark:text-[#E4E4E4]">
            <span>{item.lat}</span>
          </div>
          <div className="text-[#1E2022] md:w-104 dark:text-[#E4E4E4]">
            <span>{item.lng}</span>
        ...
        <td
          ...
          className="p-1 text-[#1E2022] rounded-[8px] cursor-pointer relative 
    hover:bg-[#F5F5F5]
