...
import SocBookMarkActionsMenu from "./SocBookMarkActionsMenu";


interface IProps {
  item: TSocialBookMark;
}


const SocBookMarksDataTableRow = ({item}: IProps) => {
  ...
  return(
    ...
    md:flex md:items-center">
      ...
      {isOpenActionsModal && <SocBookMarkActionsMenu handleActionsModal={handleActionsModal} id={item.id}/>}
    </tr>
  )
};


export default SocBookMarksDataTableRow
