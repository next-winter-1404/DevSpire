...
export default function UserInfoForm({ userId }: UserInfoFormProps) {
  ...
  const inputClasses =
    "w-full h-[48px] rounded-[16px] border border-[#DDDDDD] bg-[#FFFFFF] px-[16px] py-[8px] focus:outline-none transition-colors dark:bg-[#2A2D2F] dark:text-white dark:placeholder:text-white/40 dark:border-[#DDDDDD]/20 focus:dark:border-[#DDDDDD]/40";
