...
import { changeUserPassword } from "@/modules/userinfo/services/userService";
...
export default function ChangePasswordForm() {
    ...
    const renderEyeIcon = (isVisible: boolean, toggleFunc: () => void) => (
        ...
        >
            <Image
                src={isVisible ? "/icons/fastReservePage/eye-closed (2).svg" : "/icons/fastReservePage/Frame (1).svg"}
        ...
        >
            <div className="flex flex-col gap-2 w-full">
                ...
                {errors.currentPassword && (
                    <p className={`${isRtl ? "text-right" : "text-left"} text-[12px] text-red-500`}>
            ...
            <div className={`col-span-2 flex ${isRtl ? "justify-end" : "justify-start"} mt-4`}>
                <button
                    type="submit"
                    disabled={loading}
