...
const FilterCategoriesModal = ({ handleLocFilterModal }: IProps) => {
  ...
  const sortByOptions = [
    {
      ...
      value: "",
      label:
        locale === "en" ? "Choose your value" : "مقدار مورد نظر را انتخاب کنید",
    },
    {
      id: 2,
      value: "created_at",
      label: locale === "en" ? "Created At" : "ساخته شده",
    },
    {
      id: 3,
      value: "updated_at",
      label: locale === "en" ? "Updated At" : "ویرایش شده",
    },
    {
      id: 4,
      value: "clear",
      label: locale === "en" ? "Delete this filter" : "حذف این فیلتر",
    },
  ];
  const orderOptions = [
