...
export default function LoginPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            setErrorMsg(error.response?.data?.message || t("loginError"));
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="w-full max-w-[1344px] bg-gray-100 flex flex-col lg:flex-row justify-center items-stretch gap-[24px] lg:gap-[40px] pt-4 lg:pt-12 pb-2 lg:pb-12">
                <div className="w-full lg:w-[648px] lg:h-[880px] bg-white rounded-[40px] px-[24px] sm:px-[32px] lg:px-[48px] pt-[24px] lg:pt-[30px] pb-[32px] lg:pb-[48px] shadow-[2px_4px_8px_0px_#00000026] flex flex-col">
                    <div className="flex flex-col">
                        <div className="flex items-center gap-[3px] mt-[16px] lg:mt-[110px] animate-[fadeText_0.7s_ease] h-[24px] mb-[20px] lg:mb-[40px] animate-[fadeText_0.7s_ease]">
                            <Image
                        ...
                        <div className="w-full lg:w-[552px] flex flex-col gap-[20px] lg:gap-[32px] mb-[20px] lg:mb-[32px]">
                            <div className="relative">
                                <input
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    placeholder={t("emailPlaceholder")}
                              className={`w-full h-[62px] rounded-[40px] bg-[#F5F5F5] p-[20px] ${isRtl ? "pr-[55px] text-right" : "pl-[55px] text-left"} outline-none placeholder:text-[#665d55] text-[14px] transition-all duration-300 focus:scale-[1.01] focus:shadow-[0_0_10px_rgba(13,59,102,0.15)] animate-[fadeText_0.7s_ease]`}/>
                                <Image
                                    src="/icons/fastReservePage/Frame.svg"
                                    alt="mail icon"
                                    width={20}
                                    height={20}
                               className={`absolute top-1/2 -translate-y-1/2 ${isRtl ? "left-[20px]" : "right-[20px]"} animate-[fadeText_0.7s_ease]`} />
                            </div>
                            <div className="relative">
                                <input
                             ...
                             className={`w-full h-[62px] rounded-[40px] bg-[#F5F5F5] p-[20px] ${isRtl ? "pr-[55px] text-right" : "pl-[55px] text-left"} outline-none placeholder:text-[#665d55] text-[14px] transition-all duration-300 focus:scale-[1.01] focus:shadow-[0_0_10px_rgba(13,59,102,0.15)] animate-[fadeText_0.7s_ease]`}/>
                                <Image
                                 ...
                                 className={`absolute top-1/2 -translate-y-1/2 cursor-pointer ${isRtl ? "left-[20px]" : "right-[20px]"} animate-[fadeText_0.7s_ease]`}/>
                            </div>
                            ...
                            <button
                                ...
                                disabled={loading}
                            className="w-full h-[62px] rounded-[40px] px-[20px] flex justify-center items-center bg-[#0D3B66] text-white font-normal text-base cursor-pointer transition-all duration-200 hover:bg-[#0D3B66]/80 animate-[fadeText_0.7s_ease]" >
                        ...
                        <div className="flex flex-col sm:flex-row gap-[16px] mb-[24px]">
                            <button
                            className="w-full sm:w-[264px] h-[62px] rounded-[40px] border border-[#1E2022] text-[#1E2022] text-base flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-[#f2f2f2] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)] hover:scale-[1.02] active:scale-[0.97] animate-[fadeText_0.7s_ease]" >
                ...
                <div  className="relative hidden lg:block w-full lg:w-[648px] lg:h-[880px] rounded-[40px] overflow-hidden shadow-[2px_4px_8px_0px_#00000026] transition-transform duration-700 ease-out hover:scale-[1.01]">
                    <Image
                        src="/images/fastReservePage/login.jpg"
                        alt="login"
                        fill
                        className="object-cover  transition-transform duration-[1200ms] ease-out hover:scale-110 "/>
                    <div className="absolute bottom-[40px] left-1/2 -translate-x-1/2 w-[90%] lg:w-[599px] h-[113px] flex items-center justify-between gap-[24px] p-[32px] rounded-[40px] bg-[#00000099] shadow-[2px_4px_8px_0px_#00000026] animate-[overlayEnter_0.7s_ease] transition-all duration-300 hover:scale-[1.02]">
                        <img
                        ...
                        <div className={`flex-1 flex flex-col ${isRtl ? "text-right" : "text-left"}`}>
                            <p className="font-shabnam font-normal text-[16px] leading-[100%] tracking-[0%] mb-1 text-white transition-all duration-500 hover:text-white/90" >
                                {layoutT("imageTitle")}
                            </p>
                            <p
                           className="font-shabnam font-normal text-[14px] leading-[100%] tracking-[0%] text-white/80" >
                                {layoutT("imageDesc")}
                            </p>
                        </div>
                    </div>
