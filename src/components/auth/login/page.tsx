...
export default function LoginPage() {
  ...
  return (
    <div
      dir={isRtl ? "rtl" : "ltr"}
      className={`w-full min-h-screen bg-gray-100 flex items-center justify-center ${shabnam.className}`}
    >
        ...
        <div className="w-full lg:w-[648px] lg:h-[880px] bg-white rounded-[40px] px-[24px] sm:px-[32px] lg:px-[48px] pt-[24px] lg:pt-[30px] pb-[32px] lg:pb-[48px] shadow-[2px_4px_8px_0px_#00000026] flex flex-col">
          <div className="flex flex-col">
            ...
            <div className="flex items-center w-full lg:w-[551px] h-[22px] mb-[24px] gap-[24px] animate-[fadeText_0.7s_ease]">
              ...
              <span className="text-[#777777] text-base font-normal">
                {t("or")}
              </span>
              <div className="h-[1px] bg-[#777777] flex-1" />
            </div>
            <div className="flex flex-col sm:flex-row gap-[16px] mb-[24px]">
              <button className="w-full sm:w-[264px] h-[62px] rounded-[40px] border border-[#1E2022] text-[#1E2022] text-base flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-[#f2f2f2] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)] hover:scale-[1.02] active:scale-[0.97] animate-[fadeText_0.7s_ease]">
                <div className="flex items-center gap-[8px] ">
                  <Image
                    src="/icons/fastReservePage/google-icon-logo-svgrepo-com 1.svg"
                    width={24}
                    height={24}
                    alt=""
                  />
            ...
            <div className="w-full flex justify-center">
              <div className="flex items-center gap-[4px] animate-[fadeText_0.7s_ease]">
                <span className="text-[16px] text-black">{t("noAccount")}</span>
