...
const DashboardSidebar = ({ isSellerDashboard }: IDashboardSidebar) => {
  ...
  const sellerMenuItems = [
    ...
    {
      href: `${basePath}/estates-management`,
      label: t("estatesManagement"),
      Icon: Estates,
    },
    {
      href: `${basePath}/reserves-management`,
      label: t("reservesManagement"),
      Icon: CheckList,
    },
    {
      href: `${basePath}/finantial-management`,
      label: t("finantialManagement"),
      Icon: FinantialManagement,
    },
    {
      href: `${basePath}/comments-management`,
  ...
  return (
    <div
      className="flex flex-col gap-8 w-[268px] h-full p-8 bg-[#F5F5F5]
