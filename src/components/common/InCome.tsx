    ...
    <div className='flex flex-col flex-grow p-6 bg-[#FFFFFF] rounded-[24px] dark:bg-[#262626]'>
      <div className='flex items-center justify-between mb-6'>
        <div className='flex flex-col gap-2'>
          ...
          <p className='font-regular text-[16px] text-[#777777] dark:text-[#E4E4E4]'>{dateRange}</p>
        </div>
        <select className='py-[10px] px-4 border border-[#DDDDDD] rounded-[40px] bg-white text-[#777777] dark:bg-[#404040]'>
