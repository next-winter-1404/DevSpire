...
export default function LoginPage() {
      ...
      <div className="w-full max-w-[1344px] min-h-screen lg:h-[880px] flex flex-col lg:flex-row gap-[24px] lg:gap-[40px] px-4 ">
        <div className="w-full lg:w-[648px] h-full bg-white rounded-[40px] px-[24px] sm:px-[32px] lg:px-[48px] pt-[24px] lg:pt-[30px] pb-[32px] lg:pb-[48px] shadow-[2px_4px_8px_0px_#00000026]">
          <div className="flex flex-col">
            <div
              className="flex items-center gap-[3px] mt-[16px] lg:mt-[110px] animate-[fadeText_0.7s_ease]
 ...
 animate-[fadeText_0.7s_ease]"
            ...
            <div className="w-full lg:w-[552px] flex gap-3 flex-col mb-[20px] lg:mb-[40px] animate-[fadeText_0.7s_ease]">
              ...
              <p
                className="text-[#1E2022] text-[16px] font-normal leading-[24px] 
"
              >
            ...
            <div
              className="w-full lg:w-[552px] flex flex-col gap-[20px] lg:gap-[32px]
 mb-[20px] lg:mb-[32px]
"
            >
...
"
              ...
              <p className="text-[#0D3B66] text-[14px] leading-[100%] text-right -mt-[14px] animate-[fadeText_0.7s_ease]">
...
animate-[fadeText_0.7s_ease]
  "
              >
                <div className="flex items-center gap-[8px]">
                  <Image
                    src="/icons/fastReservePage/apple-logo-svgrepo-com 1.svg"
                    width={24}
                    height={24}
                    alt=""
                  />
            ...
            <div className="w-full flex justify-center">
              <div
                className="flex items-center gap-[4px] animate-[fadeText_0.7s_ease]"
                dir="rtl"
              >
        ...
        <div className="relative hidden lg:block  w-full lg:w-[648px] h-[260px] sm:h-[320px] lg:h-full rounded-[40px] overflow-hidden shadow-[2px_4px_8px_0px_#00000026] transition-transform duration-700 ease-out hover:scale-[1.01]">
          <Image
            src="/images/fastReservePage/login.jpg"
            alt="login"
            fill
